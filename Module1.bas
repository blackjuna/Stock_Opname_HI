...
'strnamaserver = ".\sqlexpress"
'strnamaserver = "USER-PC\SQLEXPRESS"
strnamaserver = "CAD3\SQLEXPRESS"
strnamapemakai = "sa"
strpassword = "admin123"
intconnectiontimeout = 60
strprovider = "SQLOLEDB.1"

strconstr = "Provider=" & strprovider & "; Data Source=" & "10.0.0.129, 1043" & "; Network Library=DBMSSOCN; Initial Catalog=" & strnamadatabase & ";User ID=" & strnamapemakai & ";Password=" & strpassword
